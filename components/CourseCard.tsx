...
export default function CourseCard({ title, description, image, href, badge }: CourseCardProps) {
  return (
    <Link
      href={href}
      className="group block bg-white rounded-2xl overflow-hidden shadow-eq-sm border-2 border-gold/40 hover:border-gold hover:shadow-eq-lg hover:-translate-y-1 transition-all duration-300"
    >

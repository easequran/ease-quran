...
export default function StickyMobileCTA() {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      // show after ~40% of the page has been scrolled through
      setVisible(window.scrollY > total * 0.4 - window.innerHeight);
    };
    onScroll();
    ...
    >
      <div className="flex items-stretch gap-2 bg-white border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] px-3 py-2.5">
        ...
        <a
          ...
          className="flex items-center justify-center w-14 rounded-xl bg-[#25D366] text-white shrink-0"
        >

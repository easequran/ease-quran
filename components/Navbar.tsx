        ...
        <div className="lg:hidden bg-white border-t border-gray-100 shadow-2xl max-h-[80vh] overflow-y-auto">
          <div className="container-custom py-5 flex flex-col gap-1">
            ...
            <div className="mt-4 flex flex-col gap-3">
              ...
              <a
                href="https://wa.me/923195657389?text=Hi%20I%20am%20interested%20in%20booking%20a%20free%20trial%20Quran%20class"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2.5 bg-[#25D366] text-white font-bold text-center py-3.5 rounded-xl text-sm hover:bg-[#1ebd5a] transition-all"
                onClick={() => setMobileOpen(false)}
              >

    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center bg-navy overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 50%, #F5A623 0%, transparent 50%), radial-gradient(circle at 80% 20%, #F5A623 0%, transparent 40%)",
          }}
        />
        <div className="container-custom relative z-10 pt-32 pb-20 lg:pt-40 lg:pb-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link
                  href="/free-trial"
                  className="bg-gold text-navy font-bold px-8 py-4 rounded-xl hover:bg-gold-dark transition-all duration-200 text-center text-sm"
                >
                ...
                <a
                  ...
                  className="border-2 border-white/40 text-white font-semibold px-8 py-4 rounded-xl hover:bg-white/10 transition-all duration-200 text-center text-sm flex items-center justify-center gap-2"
                >
            ...
            <div className="relative mt-8 lg:mt-0">
              {/* Main image */}
              <div className="relative rounded-3xl overflow-hidden shadow-2xl mx-auto max-w-lg lg:max-w-none" style={{ height: "520px" }}>
                <Image
              ...
              <div className="absolute -bottom-5 left-4 bg-white rounded-2xl shadow-2xl p-4 flex items-center gap-3 border border-gray-100">
                <div className="bg-gold/10 rounded-xl p-2.5">
                  <Star className="text-gold" size={22} fill="#F5A623" />
                </div>
                <div>
                  <p className="font-bold text-navy text-sm">500+ Families</p>
                  <p className="text-grey text-xs">Across the USA</p>
                </div>
              </div>

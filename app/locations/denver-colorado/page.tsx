...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Online Quran Classes in Denver, Colorado | Ease Quran Academy",
    description:
      "Certified online Quran classes for Muslim families across Denver and the Front Range, from Aurora and Westminster to Boulder.",
...
const faqs = [
  ...
  {
    question: "Can I find a Quran teacher near me in Denver?",
    answer:
      "Yes. While we are not a physical school in Denver, our online Quran academy works for any family across the Front Range searching for a Quran teacher, Quran classes, or a Hifz program near them. You connect one-on-one with a certified teacher over Zoom from home, whether you're in the city or up toward Boulder.",
  },
  {
    question: "Do you serve Denver's refugee and immigrant Muslim community?",
    answer:
      "Yes. Colorado has resettled Muslim families from Afghanistan, Somalia, Ethiopia, and several other countries over the past two decades, alongside long-established South Asian and Arab communities across the metro. We welcome families from every background, and all instruction is delivered in clear, simple English so no one is held back by language.",
  },
  {
    question: "Can classes work around Colorado's ski season and winter weather?",
    answer:
      "Yes. Many Denver-area families head to the mountains on weekends, especially during ski season, and sudden snow can make even a short evening drive across town risky. A fixed weekly class at a physical location doesn't always survive that kind of lifestyle. Online classes are easy to reschedule around a snow day or a weekend trip, and we run everything on Mountain Time to keep it simple.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. We serve the entire Denver metro and Front Range, including Aurora, Westminster, Boulder, Lakewood, Thornton, and Fort Collins. Since all classes are conducted online via Zoom, the distance between the city and the surrounding suburbs is simply not a factor.",
  },
];
    ...
    <>
        ...
        <div className="container-custom">
          <nav className="mb-6" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm text-white/50">
              ...
              <li className="text-white/30">/</li>
              <li className="text-white/80">Denver, Colorado</li>
            </ol>
          </nav>
          <div className="max-w-3xl">
            ...
            <h1 className="font-playfair font-bold text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-6">
              Online Quran Classes in Denver, Colorado
            </h1>
            <p className="text-white/70 text-lg leading-relaxed max-w-2xl mb-8">
              Certified, one-on-one Quran education for Muslim families across Denver and the Front Range. From Aurora and Westminster to Boulder and Lakewood, quality Quran instruction delivered to your home, whatever the mountain weather is doing.
            </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <span className="inline-block text-gold text-xs font-semibold tracking-widest uppercase mb-4">
              Denver's Muslim Community
            </span>
            <h2 className="font-playfair font-bold text-3xl md:text-4xl text-navy mb-6">
              A Community Built by Resettlement, Migration, and Growth
            </h2>
            <div className="space-y-5 text-grey leading-relaxed">
              <p>
                Denver's Muslim community has grown substantially over the past two decades, shaped in real part by refugee resettlement. Colorado has welcomed Muslim families from Afghanistan, Somalia, Ethiopia, and elsewhere, who have joined long-established South Asian and Arab communities across the metro. The result is a community that spans generations of American-born Muslims alongside families who arrived recently and are still building their footing, all sharing masjids and Islamic centers spread from central Denver out through Aurora and the northern suburbs.
              </p>
              <p>
                Colorado's specific challenge is its mountain lifestyle and weather. A significant number of Denver-area families head up into the mountains most weekends, especially during ski season, and an unexpected snowstorm can turn a routine evening drive to a masjid into something genuinely unsafe. Front Range traffic on I-25 adds its own delays even on a clear day. Fixed weekly classes at a physical location have to compete with a lifestyle that often revolves around the outdoors and unpredictable weather. Online Quran classes solve this by simply not caring what the mountains or the roads are doing. Class happens on schedule, snow or no snow.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-offwhite">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <span className="inline-block text-gold text-xs font-semibold tracking-widest uppercase mb-4">
              Why Online Works for Denver Families
            </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="font-playfair font-bold text-xl text-navy mb-3">Snow Doesn't Cancel Class</h3>
                <p className="text-grey text-sm leading-relaxed">
                  A sudden storm on the Front Range can make an evening drive genuinely unsafe. Online classes remove that risk completely. Your child logs into Zoom at home, and the lesson runs exactly on schedule.
                </p>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                <div className="w-12 h-12 bg-gold/10 rounded-xl flex items-center justify-center mb-4">
                ...
                <h3 className="font-playfair font-bold text-xl text-navy mb-3">Fits Around Mountain Weekends</h3>
                <p className="text-grey text-sm leading-relaxed">
                  Plenty of Denver families spend weekends up in the mountains, especially during ski season. Classes reschedule easily around a trip, so a weekend away never means falling behind.
                </p>
              </div>
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                <div className="w-12 h-12 bg-gold/10 rounded-xl flex items-center justify-center mb-4">
                ...
                <h3 className="font-playfair font-bold text-xl text-navy mb-3">Welcoming Every Family</h3>
                <p className="text-grey text-sm leading-relaxed">
                  Denver's Muslim community includes recently resettled families and generations of established South Asian and Arab households alike. Ease Quran teaches every student in clear English, wherever their family's journey to Colorado began.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/923195657389?text=Hi%20I%20am%20interested%20in%20online%20Quran%20classes%20in%20Denver%20Colorado" target="_blank" rel="noopener noreferrer" className="border-2 border-navy/20 text-navy font-semibold px-8 py-4 rounded-xl hover:bg-offwhite transition-colors text-sm text-center">
              Chat on WhatsApp
            </a>
          </div>
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="font-playfair font-bold text-3xl md:text-4xl text-navy mb-6">
              Quran Classes for Kids and Adults in Denver
            </h2>
            <p className="text-grey mb-8 leading-relaxed">
              Structured, progressive courses taught by certified scholars, designed for English-speaking Muslim families across Denver and the Front Range.
            </p>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-playfair font-bold text-3xl md:text-4xl text-navy mb-4">How to Get Started from Denver</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { step: "03", title: "Start Your Regular Classes", desc: "Love the trial? We create a consistent weekly schedule that works for your Denver-area family. Reliable, flexible, and always from the comfort of your home." },
              ].map((item) => (

...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families in Minneapolis-St. Paul. Serving one of the largest Somali Muslim communities in the USA, plus all Twin Cities suburbs. Wifaq ul Madaris certified teachers, free trial available.",
  alternates: {

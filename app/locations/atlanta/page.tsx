          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="card-title mb-3">Zero Atlanta Traffic</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="card-title mb-3">Serving Atlanta's Growing Muslim Population</h3>
                <p className="text-grey text-sm leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="card-title mb-3">Embracing Atlanta's Muslim Diversity</h3>
                <p className="text-grey text-sm leading-relaxed">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="heading-2 text-navy mb-4">How to Get Started from Atlanta</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[

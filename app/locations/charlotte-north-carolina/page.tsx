...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families in Charlotte, North Carolina. Qualified teachers, free trial available.",
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Every Ease Quran teacher holds a recognized Quran qualification. This is not a casual credential, it represents years of rigorous academic study in Quran, Tajweed, Arabic, and Islamic sciences. Charlotte-area Muslim families can have full confidence in our teachers' qualifications.",
  },
  {
...
export default function CharlotteNorthCarolinaPage() {
  return (
    <>
      ...
      <NearbyLocations slug="charlotte-north-carolina" />

...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families in Providence and the smallest state in the country. Wifaq ul Madaris certified teachers, free trial available.",
  alternates: {

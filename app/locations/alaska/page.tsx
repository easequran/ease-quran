...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families across Alaska, including Anchorage. Qualified teachers, free trial class available.",
  alternates: {
...
const faqs = [
  {
    ...
    answer: "Most of Alaska is on Alaska Time, and the far western Aleutian Islands are on Hawaii-Aleutian Time, so let us know which applies to you. Share the days and times that suit you, and every class time we confirm will be in your own time zone. When the clocks change in March and November, your class stays at the same local time.",
  },
  {
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <a href="https://wa.me/923195657389?text=Hi%20I%20am%20interested%20in%20online%20Quran%20classes%20in%20Alaska" target="_blank" rel="noopener noreferrer" className="border-2 border-white/40 text-white font-semibold px-8 py-4 rounded-full hover:bg-white/10 transition-all duration-200 text-sm text-center">
                Chat on WhatsApp
              </a>
            </div>
            <TrustBadges dark />
      ...
      <section className="section-padding bg-offwhite">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="heading-2 text-navy mb-6">Courses for Alaska Families</h2>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="heading-2 text-navy">Frequently Asked Questions. Alaska</h2>
            </div>

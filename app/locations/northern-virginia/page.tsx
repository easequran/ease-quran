          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="font-playfair font-bold text-xl text-navy mb-3">Beats Beltway Traffic</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="font-playfair font-bold text-xl text-navy mb-3">Fits Federal and Tech Careers</h3>
                <p className="text-grey text-sm leading-relaxed">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-playfair font-bold text-3xl md:text-4xl text-navy mb-4">How to Get Started from Northern Virginia</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[

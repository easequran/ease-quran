...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families in Des Moines, Iowa. Qualified teachers, free trial class available.",
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Every Ease Quran teacher holds a recognized Quran qualification. This is not a casual credential, it represents years of rigorous academic study in Quran, Tajweed, Arabic, and Islamic sciences. Iowa Muslim families can have full confidence in our teachers' qualifications.",
  },
  {
...
export default function DesMoinesIowaPage() {
  return (
    <>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/923195657389?text=Hi%20I%20am%20interested%20in%20online%20Quran%20classes%20in%20Des%20Moines%20Iowa" target="_blank" rel="noopener noreferrer" className="border-2 border-navy/20 text-navy font-semibold px-8 py-4 rounded-full hover:bg-offwhite transition-colors text-sm text-center">
              Chat on WhatsApp
            </a>
          </div>
        </div>
      ...
      <NearbyLocations slug="des-moines-iowa" />

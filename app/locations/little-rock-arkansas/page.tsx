...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families in Little Rock, without the long drive to Memphis or Dallas. Wifaq ul Madaris certified teachers, free trial.",
  alternates: {

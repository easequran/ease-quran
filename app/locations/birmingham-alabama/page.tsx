    ...
    <>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <FamilyReviews reviews={reviewsForSeed("birmingham-alabama")} heading="Real Students, Real Results" subline="Messages US families sent us on WhatsApp, shared with their permission." />

...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families in Albuquerque, a small community spread across the high desert. Wifaq ul Madaris certified teachers, free trial.",
  alternates: {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="font-playfair font-bold text-xl text-navy mb-3">No Drive Across the Mesa</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="font-playfair font-bold text-xl text-navy mb-3">Reaches the Whole High Desert</h3>
                <p className="text-grey text-sm leading-relaxed">
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-playfair font-bold text-3xl md:text-4xl text-navy mb-4">How to Get Started from Albuquerque</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[

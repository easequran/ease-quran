...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families across Vermont, including Burlington. Qualified teachers, free trial class available.",
  alternates: {
...
const faqs = [
  {
    ...
    answer: "Vermont is on Eastern Time. Share the days and times that suit you, and every class time we confirm will be in your own time zone. When the clocks change in March and November, your class stays at the same local time.",
  },
  {
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <a href="https://wa.me/923195657389?text=Hi%20I%20am%20interested%20in%20online%20Quran%20classes%20in%20Vermont" target="_blank" rel="noopener noreferrer" className="border-2 border-white/40 text-white font-semibold px-8 py-4 rounded-full hover:bg-white/10 transition-all duration-200 text-sm text-center">
                Chat on WhatsApp
              </a>
            </div>
            <TrustBadges dark />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-5 text-grey leading-relaxed">
              ...
              <p>
                ...
                remains the nearest Ease Quran city page, since it's the closest US city we serve. Our online classes reach you directly in Vermont either way, no drive toward Boston or Montreal required.
              </p>
            </div>
          </div>
        </div>

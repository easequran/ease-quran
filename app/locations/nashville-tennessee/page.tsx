...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families in Nashville, Tennessee. Qualified teachers, free trial available.",
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. Every Ease Quran teacher holds a recognized Quran qualification. This is not a casual credential, it represents years of rigorous academic study in Quran, Tajweed, Arabic, and Islamic sciences. Nashville-area Muslim families can have full confidence in our teachers' qualifications.",
  },
  {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="card-title mb-3">Beats Nashville's Booming Traffic</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                ...
                <h3 className="card-title mb-3">Fits a Fast-Moving City</h3>
                <p className="text-grey text-sm leading-relaxed">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://wa.me/923195657389?text=Hi%20I%20am%20interested%20in%20online%20Quran%20classes%20in%20Nashville%20Tennessee" target="_blank" rel="noopener noreferrer" className="border-2 border-navy/20 text-navy font-semibold px-8 py-4 rounded-full hover:bg-offwhite transition-colors text-sm text-center">
              Chat on WhatsApp
            </a>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="heading-2 text-navy mb-4">How to Get Started from Nashville</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[

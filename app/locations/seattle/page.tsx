...
export const metadata: Metadata = {
  ...
  description:
    "Certified online Quran classes for Muslim families in Seattle. Serving tech-industry and East African households. Wifaq ul Madaris certified teachers, free trial available.",
  alternates: {
